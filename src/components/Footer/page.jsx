...
<footer className="bg-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              ...
              <Link href="https://flowbite.com/" className="flex items-center">
                  <Image src="" className="h-8 mr-3" alt="YIP Logo" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white text-blue-500">YIP Logistics</span>
              </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <Link href="#" className="hover:underline">YIP Logistics</Link>
                      </li>
                      <li>
                          <Link href="#" className="hover:underline">Patronise</Link>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400"> 2023 &copy; <a href="https://flowbite.com/" className="hover:underline">YIP Logistics™</a>. All Rights Reserved.
          </span>
